...
// export type ComposeConfigs<Configs> = Configs extends [infer Head, ...infer Rest]
//     ? Head extends object ? Rest extends object[] 
//     ? Head & ComposeConfigs<Rest> : Head : ComposeConfigs<Rest>
//     : {}

export type ComposeConfigs<Configs, Acc = {}> = Configs extends [infer Head, ...infer Rest]?
ComposeConfigs<Rest, Acc & Head> : Acc
// --- Usage Examples ---
