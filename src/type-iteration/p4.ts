...
type typeKey = "type"
type FilterSensors<SensorList, AllowedTypes> = SensorList extends [infer Head, ...infer Rest] ?
    Head extends Sensor ? Head[typeKey] extends AllowedTypes ?
    [Head, ...FilterSensors<Rest, AllowedTypes>] : FilterSensors<Rest, AllowedTypes>
