...
type ExtractInnerType<arr> = arr extends (infer type)[] ? type : never;

type SyncReadings<Streams> = Streams extends [infer Head, ...infer Rest] ?
    [ExtractInnerType<Head>, ...SyncReadings<Rest>]
    : []
    ;
